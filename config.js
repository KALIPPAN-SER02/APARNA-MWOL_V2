...
module.exports = {
    ...
    SESSION: process.APARNA_CODE === undefined ? '' : process.env.APARNA_CODE,
    ANTİLİNK: process.env.ANTİ_LİNK === undefined ? 'false' : process.env.ANTİ_LİNK,
    AUTOBİO: process.env.AUTO_BİO === undefined ? 'false' : process.env.AUTO_BİO,
    AFN: process.env.ALL_CAPTION === undefined ? 'APARNA MWOL V2 BY KALIPPAN' : process.env.ALL_CAPTION,
    ...
    BOTSK: process.env.BOT_NAME === undefined ? '᭓Aᴘᴀʀɴᴀ Mᴡᴏʟ᭄↹🎀🪄' : process.env.BOT_NAME,
    LOGOSK: process.env.ALL_IMG === undefined ? 'https://www.linkpicture.com/q/IMG-20220327-WA0949_1.jpg' : process.env.ALL_IMG,
    SLINK: process.env.SOCIAL_MEDIA === undefined ? 'https://www.instagram.com/_midhun_x3__' : process.env.SOCIAL_MEDIA,
    ...
    SUDO: process.env.SUDO === undefined ? '918281370025,0' : process.env.SUDO,
    DEBUG: DEBUG,
